            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorUsername" CssClass="text-danger" runat="server" ErrorMessage="The username field is required" ControlToValidate="tbUname"></asp:RequiredFieldValidator>
                 ...
                 <div class="form-group">
                     ...
                     <div class="col-md-6">
                         <asp:Button ID="Button1" runat="server" Text="Login" CssClass="btn btn-info" OnClick="Button1_Click" />
